"""
ComfyUI-Custom - ComfyUI custom node package
"""
...
from .store_bbox_json import JSON_CLASS_MAPPINGS, JSON_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(JSON_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(JSON_NAME_MAPPINGS)
